...
class _ProfileEditAppBarState extends State<ProfileEditAppBar> {
  ...
  Future<Image> convertFileToImage(File picture) async {
    ...
    setState(() {
      controller.deliveryBoyImage = image as File;
    });
  ...
  Future pickImage(ImageSource sr) async {
    try {
      ...
      setState(() {
        controller.deliveryBoyImage = imageTemporary;
        (File(image.path));
              ...
              Positioned(
                ...
                child: Container(
                  ...
                  child: Center(
                    child: Stack(
                      children: [
                        controller.deliveryBoyImage != null
                            ? ClipRRect(
                                borderRadius: BorderRadius.circular(100),
                                child: Image.file(
                                  controller.deliveryBoyImage!,
                                  fit: BoxFit.cover,
                                  height: 150,
                                  width: 150,
                                ),
                              )
                            : controller.deliveryBoyModel.value!.profileImage !=
                                    ""
                                ? ClipRRect(
                                    borderRadius: BorderRadius.circular(100),
                                    child: Image.network(
                                      controller.deliveryBoyModel.value!
                                          .profileImage!,
                                      height: 150,
                                      width: 150,
                                      fit: BoxFit.cover,
